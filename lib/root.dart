...
class Root extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    const items = [
      ...
      BottomNavigationBarItem(icon: Icon(Icons.person), label: '履歴'),
      BottomNavigationBarItem(icon: Icon(Icons.person), label: 'セット一覧'),
      BottomNavigationBarItem(icon: Icon(Icons.person), label: '種目一覧'),
